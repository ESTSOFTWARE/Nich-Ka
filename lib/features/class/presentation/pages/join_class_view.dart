...
class JoinClassView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final state = ref.watch(joinClassProvider(initialCode));
    final notifier = ref.read(joinClassProvider(initialCode).notifier);
            ...
            children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        QrScannerFrame(
                          ...
                          onDetected: notifier.onQrDetected,
                        ),
                        ...
                        TextField(
                          ...
                          controller: notifier.linkController,
                          style: GoogleFonts.poppins(
                            fontSize: 13,
                            color: palette.textPrimary,
                          ),
                        ...
                        ClassCodeInput(
                          ...
                          focusNode: notifier.codeFocusNode,
                          code: state.code,
                          palette: palette,
                        ),
                      ],
              ...
              Padding(
                ...
                child: SizedBox(
                  ...
                  child: FilledButton(
                    onPressed: state.joinState is UiLoading
                        ? null
                        : () async {
                            final ok = await notifier.onSearch();
                            ...
                            if (ok) {
                              ...
                              // a la que se unió.
                              final joined = state.joinedClass;
                              if (joined != null) {
                            ...
                            } else if (state.joinState is UiError) {
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text(
                                    (state.joinState as UiError).message,
                                  ),
                    ...
                    child: state.joinState is UiLoading
                        ? const SizedBox(
                            height: 20,
                            width: 20,
